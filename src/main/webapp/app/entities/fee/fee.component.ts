...
export class FeeComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.feeService
      ...
      .subscribe((res: HttpResponse<IFee[]>) => this.paginateFees(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IFee) {
    return item.id;
  }
  ...
  protected paginateFees(data: IFee[], headers: HttpHeaders) {
